...
```bash
docker run --rm -v "$PWD":/app -w /app ghcr.io/dakimura/guff:0.3.0 run ./...
```
...
curl -fsSL -o guff.tgz \
  https://github.com/dakimura/guff/releases/download/v0.3.0/guff_0.3.0_darwin_arm64.tar.gz
curl -fsSL -o guff.tgz.sha256 \
  https://github.com/dakimura/guff/releases/download/v0.3.0/guff_0.3.0_darwin_arm64.tar.gz.sha256

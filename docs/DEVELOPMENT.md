...
| プリセット | `standard`/`fast`/`all`/`none`。ただし `standard`==`all`（5 系統）。追加系は `--enable`（） | 100+ linter を跨ぐ本来の `all`/`fast`/カテゴリプリセットに未対応 |
...
- **完了条件**: 各 linter に bad/ok testdata、`go vet`/golangci 相当の指摘、レジストリ登録。
  ...
  4. `guff-style`（新）: **copyloopvar**（`check-alias` settings 済）/ **usetesting**（per-check flags settings 済）/
     **usestdlibvars**（HTTP method/status 既定オン + optional tables settings 済）
     ...
     / **gosec**（securego/gosec；G101/G102/G103/G104/G106/G107/G108/G109/G111/G112/G114/G203/G204/G301/G302/G303/G306/G401/G402/G403/G404/G405/G406/G501–G507；`linters.settings.gosec` の `includes`/`excludes` 配線済。G110/G113/G115–G118・G201–G202・G304–G305/G307・G402 MinVersion/CipherSuites・G601・G101 zxcvbn/`#nosec`・G104 config allowlist / audit mode・G107 local TryResolve・G204 TryResolve 完全パリティ・G102 Ident const・severity/confidence/config は DEFERRED）
  ...
  **DEFERRED（同タスク内の残り）**:
   ...
   - ~~`gosec`（初回バッチ）~~ → **拡充**（2026-07-17；第2バッチ G102/G106/G108/G114/G204 + 第3バッチ **G101** hardcoded credentials + 第4バッチ **G104** unchecked errors + 第5バッチ **G111** / **G301** / **G302** / **G306** / **G402** / **G403** + 第6バッチ **G107**（variable URL SSRF；BasicLit/Const 安全・local TryResolve DEFERRED）/ **G109**（`strconv.Atoi`→`int16`/`int32`）/ **G112**（`http.Server` Slowloris）/ **G203**（`html/template` non-escaping）/ **G303**（predictable `/tmp` path）。計 G101/G102/G103/G104/G106/G107/G108/G109/G111/G112/G114/G203/G204/G301/G302/G303/G306/G401/G402/G403/G404/G405/G406/G501–G507 + `includes`/`excludes`。zxcvbn 完全パリティ・`#nosec`/`gosec:disable`・G104 config allowlist / audit mode・G110/G113/G115–G118・G201–G202・G304–G305/G307・G601・G107 local TryResolve・G204 TryResolve / G102 Ident const・severity/confidence/config は DEFERRED）

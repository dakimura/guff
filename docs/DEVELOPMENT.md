...
- **完了条件**: 各 linter に bad/ok testdata、`go vet`/golangci 相当の指摘、レジストリ登録。
  ...
  4. `guff-style`（新）: **copyloopvar**（`check-alias` settings 済）/ **usetesting**（per-check flags settings 済）/
     **usestdlibvars**（HTTP method/status 既定オン + optional tables settings 済）
     ...
     / **gosec**（securego/gosec；G101/G102/G103/G106/G108/G114/G204/G401/G404/G405/G406/G501–G507；`linters.settings.gosec` の `includes`/`excludes` 配線済。G104・G107/G109–G113/G115–G118・G201–G203・G301–G307・G402–G403・G601・G101 zxcvbn/`#nosec`・G204 TryResolve 完全パリティ・G102 Ident const・severity/confidence/config は DEFERRED）
  ...
  **DEFERRED（同タスク内の残り）**:
   ...
   - ~~`gosec`（初回バッチ）~~ → **拡充**（2026-07-17；第2バッチ G102/G106/G108/G114/G204 + 第3バッチ **G101** hardcoded credentials。計 G101/G102/G103/G106/G108/G114/G204/G401/G404/G405/G406/G501–G507 + `includes`/`excludes`。G101 は AssignStmt/ValueSpec/BinaryExpr/CompositeLit + 名前パターン + Shannon entropy 近似 + secret regex。zxcvbn 完全パリティ・`#nosec`/`gosec:disable`・G104・G107/G109–G113/G115–G118・G201–G203・G301–G307・G402–G403・G601・G204 TryResolve / G102 Ident const・severity/confidence/config は DEFERRED）

...
- **完了条件**: 各 linter に bad/ok testdata、`go vet`/golangci 相当の指摘、レジストリ登録。
  ...
  4. `guff-style`（新）: **copyloopvar**（`check-alias` settings 済）/ **usetesting**（per-check flags settings 済）/
     **usestdlibvars**（HTTP method/status 既定オン + optional tables settings 済）
     ...
     / **modernize**（x/tools modernize；any / plusbuild / forvar / rangeint / minmax / fmtappendf / omitzero / slicessort / **stringscutprefix** / **slicescontains** / **stringsseq** / **waitgroupgo** / **mapsloop**；`linters.settings.modernize.disable` 済）
  ...
  **DEFERRED（同タスク内の残り）**:
   ...
   - ~~`modernize`（コア checker）~~ → **拡充**（2026-07-16；any / plusbuild / forvar / rangeint / minmax / fmtappendf / omitzero / slicessort + **stringscutprefix** / **slicescontains** / **stringsseq** / **waitgroupgo** / **mapsloop**（map→map `Copy`）+ `disable` settings。atomictypes / embedlit / errorsastype / newexpr / reflecttypefor / slicesbackward / stditerators / stringscut / stringsbuilder / testingcontext / unsafefuncs、mapsloop Insert/Collect/Clone、cutprefix pattern2/bytes、slicescontains ContainsFunc/break、waitgroupgo trailing-Done、rangeint/minmax 完全パリティは DEFERRED）

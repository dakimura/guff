...
補足（2026-07-17）: `gocritic` enable-all extras に **`badLock`** / **`externalErrorReassign`** / **`uncheckedInlineErr`** / **`boolExprSimplify`**（コア）を追加し、計 **106** checker（default 34 + extras 72）。`boolExprSimplify` の removeIncDec / foldRanges、`regexpSimplify`、`ruleguard` ホストは DEFERRED。
